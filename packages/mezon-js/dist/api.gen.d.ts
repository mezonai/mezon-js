...
export declare class MezonApi {
    ...
    listChannelUsers(bearerToken: string, channelId: string, channelType: number, limit?: number, state?: number, cursor?: string, options?: any): Promise<ApiChannelUserList>;
    /** List clans */
