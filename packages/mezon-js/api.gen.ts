...
export interface MezonUpdateOnboardingBody {
  //
  answers?: Array<ApiOnboardingAnswer>;
  //
  channel_id?: string;
  //
  clan_id?: string;
...
/**  */
export interface MezonUpdateOnboardingStepBody {
  //onboarding step.
...
export interface ApiChannelDescList {
  ...
  //A list of channel.
  channeldesc?: Array<MezonapiChannelDescription>;
...
/**  */
export interface ApiClanWebhookHandlerBody {
  //list clan webhook.
...
export interface ApiEmojiListedResponse {
  //
  emoji_list?: Array<MezonapiClanEmoji>;
}
...
/**  */
export interface ApiGenerateHashChannelAppsResponse {
  //
  web_app_data?: string;
}
...
export interface ApiHashtagDmList {
  //
  hashtag_dm?: Array<MezonapiHashtagDm>;
}

/** Add link invite users to. */
export interface ApiInviteUserRes {
  //
  channel_desc?: MezonapiChannelDescription;
...
export interface ApiNotification {
  ...
  category?: number;
  //
  channel?: MezonapiChannelDescription;
  //
  channel_id?: string;
  //
  channel_type?: number;
...
export interface ApiNotificationChannelCategorySettingList {
  //
  notification_channel_category_settings_list?: Array<MezonapiNotificationChannelCategorySetting>;
}
...
/**  */
export interface ApiOnboardingAnswer {
  //
  description?: string;
  //
  emoji?: string;
...
export interface ApiPermissionRoleChannelListEventResponse {
  ...
  channel_id?: string;
  //
  permission_role_channel?: Array<MezonapiPermissionRoleChannel>;
  //
  role_id?: string;
  //
  user_id?: string;
...
/**  */
export interface MezonapiChannelDescription {
  //
...
/**  */
export interface MezonapiClanEmoji {
  //
  category?: string;
  //
  clan_id?: string;
...
/**  */
export interface MezonapiHashtagDm {
  //The channel id.
  channel_id?: string;
  //
  channel_label?: string;
...
/**  */
export interface MezonapiNotificationChannelCategorySetting {
  //
  action?: number;
  //
...
/**  */
export interface MezonapiPermissionRoleChannel {
  //
  active?: boolean;
  //
  permission_id?: string;
...
/**  */
export interface RealtimeFCMTokens {
  //deviceID to follow.
  device_id?: string;
  //platform to follow.
  platform?: string;
...
/**  */
export interface RealtimeUserProfileRedis {
  //
  about_me?: string;
  //
  app_token?: string;
  ...
  display_name?: string;
  //
  fcm_tokens?: Array<RealtimeFCMTokens>;
  //
  is_bot?: boolean;
  //
  is_disabled?: boolean;
  //
  joined_clans?: Array<string>;
  //
  metadata?: string;
  //
  mezon_id?: string;
...
export class MezonApi {
  ...
  constructor(readonly serverKey apiKey: string, readonly basePath: string, readonly timeoutMs: number) {}
  ...
  generateHashChannelApps(bearerToken: string,
      appId?:string,
      options: any = {}): Promise<ApiGenerateHashChannelAppsResponse> {
  ...
  changeChannelCategory(bearerToken: string,
    ...
    const urlPath = "/v2/channel/category/{newCategoryId}"
  ...
  addChannelFavorite(bearerToken: string,
      ...
      options: any = {}): Promise<ApiAddFavoriteChannelResponse> {
  ...
  createChannelDesc(bearerToken: string,
      ...
      options: any = {}): Promise<MezonapiChannelDescription> {
  ...
  handleClanWebhook(bearerToken: string,
      token:string,
      username:string,
      body:ApiClanWebhookHandlerBody,
      options: any = {}): Promise<any> {
    ...
    if (username === null || username === undefined) {
      throw new Error("'username' is a required parameter but is null or undefined.");
    }
    if (body === null || body === undefined) {
      throw new Error("'body' is a required parameter but is null or undefined.");
    }
    const urlPath = "/v2/clanwebhooks/{token}/{username}"
  ...
  /** Generate Meet Token */
  generateMeetToken(bearerToken: string,
  ...
  updateOnboardingStep(bearerToken: string,
      clanId:string,
      body:MezonUpdateOnboardingStepBody,
      options: any = {}): Promise<any> {
  ...
  getPermissionByRoleIdChannelId(bearerToken: string,
      roleId?:string,
      channelId?:string,
      userId?:string,
      options: any = {}): Promise<ApiPermissionRoleChannelListEventResponse> {
  ...
  /** Delete Sd Topic */
  deleteSdTopic(bearerToken: string,
      channelId?:string,
      id?:string,
      clanId?:string,
      options: any = {}): Promise<any> {
  ...
  listSdTopic(bearerToken: string,
      clanId?:string,
      limit?:number,
      options: any = {}): Promise<ApiSdTopicList> {
  ...
  /** Create Sd Topic */
  createSdTopic(bearerToken: string,
  ...
  streamingServerCallback(bearerToken: string,
      ...
      options: any = {}): Promise<ApiStreamHttpCallbackResponse> {
  ...
  /** Block one or more users by ID or username. */
  updateUserProfileRedis(bearerToken: string,
      body:RealtimeUserProfileRedis,
      options: any = {}): Promise<any> {
    
    if (body === null || body === undefined) {
      throw new Error("'body' is a required parameter but is null or undefined.");
    }
    const urlPath = "/v2/user/profile";
    const queryParams = new Map<string, any>();
  ...
  /** Delete user event */
  deleteUserEvent(bearerToken: string,
      clanId?:string,
      eventId?:string,
      options: any = {}): Promise<any> {
  ...
  /** Add user event */
  addUserEvent(bearerToken: string,
  ...
  /** webhook */
  handleWebhook(bearerToken: string,
      channelId:string,
      token:string,
      body:,
      options: any = {}): Promise<any> {
