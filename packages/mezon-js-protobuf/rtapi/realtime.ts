...
export interface HashtagDmListEvent {
  ...
  limit:
    ...
    | undefined;
  /** A list of channel. */
  hashtag_dm: HashtagDmList | undefined;
}
...
export interface ChannelDescListEvent {
  /** A list of channel. */
  channeldesc: ChannelDescList | undefined;
}
...
export interface NotificationChannelCategorySettingEvent {
  clan_id: string;
  notification_channel_category_settings_list: NotificationChannelCategorySettingList | undefined;
}
...
function createBaseHashtagDmListEvent(): HashtagDmListEvent {
  return { user_id: [], limit: undefined, hashtag_dm: undefined };
}
...
export const HashtagDmListEvent = {
  encode(message: HashtagDmListEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.hashtag_dm !== undefined) {
  ...
  fromJSON(object: any): HashtagDmListEvent {
    return {
      ...
      limit: isSet(object.limit) ? Number(object.limit) : undefined,
      hashtag_dm: isSet(object.hashtag_dm) ? HashtagDmList.fromJSON(object.hashtag_dm) : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<HashtagDmListEvent>, I>>(object: I): HashtagDmListEvent {
    ...
    message.limit = object.limit ?? undefined;
    message.hashtag_dm = (object.hashtag_dm !== undefined && object.hashtag_dm !== null)
      ? HashtagDmList.fromPartial(object.hashtag_dm)
      : undefined;
    return message;
  },
};
...
export const ChannelDescListEvent = {
  ...
  fromJSON(object: any): ChannelDescListEvent {
    return { channeldesc: isSet(object.channeldesc) ? ChannelDescList.fromJSON(object.channeldesc) : undefined };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ChannelDescListEvent>, I>>(object: I): ChannelDescListEvent {
    const message = createBaseChannelDescListEvent();
    message.channeldesc = (object.channeldesc !== undefined && object.channeldesc !== null)
      ? ChannelDescList.fromPartial(object.channeldesc)
      : undefined;
    return message;
  },
};
...
function createBaseNotificationChannelCategorySettingEvent(): NotificationChannelCategorySettingEvent {
  return { clan_id: "", notification_channel_category_settings_list: undefined };
}
...
export const NotificationChannelCategorySettingEvent = {
  encode(message: NotificationChannelCategorySettingEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.notification_channel_category_settings_list !== undefined) {
  ...
  fromJSON(object: any): NotificationChannelCategorySettingEvent {
    return {
      clan_id: isSet(object.clan_id) ? globalThis.String(object.clan_id) : "",
      notification_channel_category_settings_list: isSet(object.notification_channel_category_settings_list)
        ? NotificationChannelCategorySettingList.fromJSON(object.notification_channel_category_settings_list)
        : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<NotificationChannelCategorySettingEvent>, I>>(
    ...
    message.clan_id = object.clan_id ?? "";
    message.notification_channel_category_settings_list =
      (object.notification_channel_category_settings_list !== undefined &&
          object.notification_channel_category_settings_list !== null)
        ? NotificationChannelCategorySettingList.fromPartial(object.notification_channel_category_settings_list)
        : undefined;
    return message;
  },
};
