...
export const Envelope = {
  encode(message: Envelope, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.event_status_notification_event !== undefined) {
      EventStatusNotificationEvent.encode(message.event_status_notification_event, writer.uint32(442).fork()).ldelim();
    }
    return writer;
  },
  ...
  toJSON(message: Envelope): unknown {
    ...
    if (message.event_status_notification_event !== undefined) {
      obj.event_status_notification_event = EventStatusNotificationEvent.toJSON(
...
export const EventStatusNotificationEvent = {
  ...
  create<I extends Exact<DeepPartial<EventStatusNotificationEvent>, I>>(base?: I): EventStatusNotificationEvent {
    return EventStatusNotificationEvent.fromPartial(base ?? ({} as any));
  },
