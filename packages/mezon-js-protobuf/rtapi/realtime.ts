...
export interface Envelope {
  ...
  channel_archive_event?:
    | ChannelArchiveEvent
    | undefined;
  /** Topic in message event */
  topic_in_message_event?:
    | TopicInMessageEvent
    | undefined;
  /** share screen event */
  screen_share_event?:
...
export const Envelope = {
  encode(message: Envelope, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.topic_in_message_event !== undefined) {
      TopicInMessageEvent.encode(message.topic_in_message_event, writer.uint32(786).fork()).ldelim();
    }
    if (message.screen_share_event !== undefined) {
      ScreenShareEvent.encode(message.screen_share_event, writer.uint32(794).fork()).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 98:
          ...
          message.topic_in_message_event = TopicInMessageEvent.decode(reader, reader.uint32());
          continue;
        case 99:
          if (tag !== 794) {
            break;
          ...
          message.screen_share_event = ScreenShareEvent.decode(reader, reader.uint32());
          continue;
        case 100:
          if (tag !== 802) {
            break;
  ...
  fromJSON(object: any): Envelope {
    return {
      ...
      channel_archive_event: isSet(object.channel_archive_event)
        ...
        : undefined,
      topic_in_message_event: isSet(object.topic_in_message_event)
        ? TopicInMessageEvent.fromJSON(object.topic_in_message_event)
        : undefined,
      screen_share_event: isSet(object.screen_share_event)
        ? ScreenShareEvent.fromJSON(object.screen_share_event)
        : undefined,
  ...
  toJSON(message: Envelope): unknown {
    ...
    if (message.topic_in_message_event !== undefined) {
      obj.topic_in_message_event = TopicInMessageEvent.toJSON(message.topic_in_message_event);
    }
    if (message.screen_share_event !== undefined) {
      obj.screen_share_event = ScreenShareEvent.toJSON(message.screen_share_event);
    }
    if (message.voice_interactive_event !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<Envelope>, I>>(object: I): Envelope {
    ...
    message.channel_archive_event =
      (object.channel_archive_event !== undefined && object.channel_archive_event !== null)
        ...
        : undefined;
    message.topic_in_message_event =
      (object.topic_in_message_event !== undefined && object.topic_in_message_event !== null)
        ? TopicInMessageEvent.fromPartial(object.topic_in_message_event)
        : undefined;
    message.screen_share_event = (object.screen_share_event !== undefined && object.screen_share_event !== null)
      ? ScreenShareEvent.fromPartial(object.screen_share_event)
      : undefined;
    message.voice_interactive_event =
...
function createBaseVoiceInteractiveEvent(): VoiceInteractiveEvent {
  return { clan_id: "0", voice_channel_id: "0", sender_id: "0", receiver_id: "0", event_type: 0, params: "" };
}

export const VoiceInteractiveEvent = {
  encode(message: VoiceInteractiveEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.clan_id !== "0") {
      writer.uint32(8).int64(message.clan_id);
    }
    if (message.voice_channel_id !== "0") {
      writer.uint32(16).int64(message.voice_channel_id);
    }
    if (message.sender_id !== "0") {
      writer.uint32(24).int64(message.sender_id);
    }
    if (message.receiver_id !== "0") {
      writer.uint32(32).int64(message.receiver_id);
    }
    if (message.event_type !== 0) {
      writer.uint32(40).int32(message.event_type);
    }
    if (message.params !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): VoiceInteractiveEvent {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseVoiceInteractiveEvent();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): VoiceInteractiveEvent {
    return {
      ...
      event_type: isSet(object.event_type) ? globalThis.Number(object.event_type) : 0,
      params: isSet(object.params) ? globalThis.String(object.params) : "",
    };
  },

  toJSON(message: VoiceInteractiveEvent): unknown {
    const obj: any = {};
    if (message.clan_id !== "0") {
    ...
    if (message.event_type !== 0) {
      obj.event_type = Math.round(message.event_type);
    }
    if (message.params !== "") {
  ...
  create<I extends Exact<DeepPartial<VoiceInteractiveEvent>, I>>(base?: I): VoiceInteractiveEvent {
    return VoiceInteractiveEvent.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<VoiceInteractiveEvent>, I>>(object: I): VoiceInteractiveEvent {
    const message = createBaseVoiceInteractiveEvent();
...
function createBaseScreenShareEvent(): ScreenShareEvent {
  return { clan_id: "0", voice_channel_id: "0", user_id: "0", is_sharing: false };
}

export const ScreenShareEvent = {
  encode(message: ScreenShareEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.clan_id !== "0") {
      writer.uint32(8).int64(message.clan_id);
    }
    if (message.voice_channel_id !== "0") {
    ...
    if (message.is_sharing !== false) {
      writer.uint32(32).bool(message.is_sharing);
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): ScreenShareEvent {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.is_sharing = reader.bool();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ScreenShareEvent {
    return {
      clan_id: isSet(object.clan_id) ? globalThis.String(object.clan_id) : "0",
      voice_channel_id: isSet(object.voice_channel_id) ? globalThis.String(object.voice_channel_id) : "0",
      user_id: isSet(object.user_id) ? globalThis.String(object.user_id) : "0",
      is_sharing: isSet(object.is_sharing) ? globalThis.Boolean(object.is_sharing) : false,
    };
  },

  toJSON(message: ScreenShareEvent): unknown {
    const obj: any = {};
    if (message.clan_id !== "0") {
      obj.clan_id = message.clan_id;
    }
    ...
    if (message.is_sharing !== false) {
      obj.is_sharing = message.is_sharing;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ScreenShareEvent>, I>>(object: I): ScreenShareEvent {
    ...
    message.is_sharing = object.is_sharing ?? false;
    return message;
  },
};
...
export const TopicInMessageEvent = {
  encode(message: TopicInMessageEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.message_id !== "0") {
      writer.uint32(8).int64(message.message_id);
    }
    if (message.rpl !== 0) {
      writer.uint32(16).int32(message.rpl);
    }
    if (message.lsnt !== "0") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TopicInMessageEvent {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseTopicInMessageEvent();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): TopicInMessageEvent {
    return {
  ...
  toJSON(message: TopicInMessageEvent): unknown {
    const obj: any = {};
    if (message.message_id !== "0") {
      obj.message_id = message.message_id;
    }
    if (message.rpl !== 0) {
      obj.rpl = Math.round(message.rpl);
    }
    if (message.lsnt !== "0") {
  ...
  create<I extends Exact<DeepPartial<TopicInMessageEvent>, I>>(base?: I): TopicInMessageEvent {
    return TopicInMessageEvent.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TopicInMessageEvent>, I>>(object: I): TopicInMessageEvent {
    const message = createBaseTopicInMessageEvent();
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): EphemeralMessageSend {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          if (tag === 16) {
            message.receiver_ids.push(longToString(reader.int64() as Long));
  ...
  fromJSON(object: any): EphemeralMessageSend {
    return {
      ...
      receiver_ids: globalThis.Array.isArray(object?.receiver_ids)
        ? object.receiver_ids.map((e: any) => globalThis.String(e))
        : [],
    };
  },
...
export const ClanUpdatedEvent = {
  encode(message: ClanUpdatedEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.hashtags !== "") {
      writer.uint32(114).string(message.hashtags);
    }
    if (message.short_url !== "") {
      writer.uint32(122).string(message.short_url);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 14:
          ...
          message.hashtags = reader.string();
          continue;
        case 15:
          if (tag !== 122) {
            break;
  ...
  fromJSON(object: any): ClanUpdatedEvent {
    return {
      ...
      hashtags: isSet(object.hashtags) ? globalThis.String(object.hashtags) : "",
  ...
  fromPartial<I extends Exact<DeepPartial<ClanUpdatedEvent>, I>>(object: I): ClanUpdatedEvent {
    ...
    message.hashtags = object.hashtags ?? "";
