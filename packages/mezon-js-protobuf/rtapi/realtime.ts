...
export interface Envelope {
  ...
  event_create_emoji?: EventCreateEmoji | undefined;
  event_update_emoji?: EventUpdateEmoji | undefined;
  event_delete_emoji?: EventDeleteEmoji | undefined;
}
...
export interface EventCreateEmoji {
  id: string;
  clan_id: string;
  short_name: string;
  source: string;
...
export interface EventUpdateEmoji {
  id: string;
  clan_id: string;
  short_name: string;
  source: string;
...
export interface EventDeleteEmoji {
  id: string;
  clan_id: string;
}
...
function createBaseEnvelope(): Envelope {
  return {
    ...
    event_create_emoji: undefined,
    event_update_emoji: undefined,
    event_delete_emoji: undefined,
  };
}
...
export const Envelope = {
  encode(message: Envelope, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.event_create_emoji !== undefined) {
      EventCreateEmoji.encode(message.event_create_emoji, writer.uint32(514).fork()).ldelim();
    }
    if (message.event_update_emoji !== undefined) {
      EventUpdateEmoji.encode(message.event_update_emoji, writer.uint32(522).fork()).ldelim();
    }
    if (message.event_delete_emoji !== undefined) {
      EventDeleteEmoji.encode(message.event_delete_emoji, writer.uint32(530).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 64:
          ...
          message.event_create_emoji = EventCreateEmoji.decode(reader, reader.uint32());
          continue;
        case 65:
          if (tag !== 522) {
            break;
          ...
          message.event_update_emoji = EventUpdateEmoji.decode(reader, reader.uint32());
          continue;
        case 66:
          if (tag !== 530) {
            break;
          ...
          message.event_delete_emoji = EventDeleteEmoji.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): Envelope {
    return {
      ...
      sticker_delete_event: isSet(object.sticker_delete_event)
        ...
        : undefined,
      event_create_emoji: isSet(object.event_create_emoji)
        ? EventCreateEmoji.fromJSON(object.event_create_emoji)
        : undefined,
      event_update_emoji: isSet(object.event_update_emoji)
        ? EventUpdateEmoji.fromJSON(object.event_update_emoji)
        : undefined,
      event_delete_emoji: isSet(object.event_delete_emoji)
        ? EventDeleteEmoji.fromJSON(object.event_delete_emoji)
        : undefined,
    };
  },
  ...
  toJSON(message: Envelope): unknown {
    ...
    if (message.event_create_emoji !== undefined) {
      obj.event_create_emoji = EventCreateEmoji.toJSON(message.event_create_emoji);
    }
    if (message.event_update_emoji !== undefined) {
      obj.event_update_emoji = EventUpdateEmoji.toJSON(message.event_update_emoji);
    }
    if (message.event_delete_emoji !== undefined) {
      obj.event_delete_emoji = EventDeleteEmoji.toJSON(message.event_delete_emoji);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Envelope>, I>>(object: I): Envelope {
    ...
    message.sticker_delete_event = (object.sticker_delete_event !== undefined && object.sticker_delete_event !== null)
      ...
      : undefined;
    message.event_create_emoji = (object.event_create_emoji !== undefined && object.event_create_emoji !== null)
      ? EventCreateEmoji.fromPartial(object.event_create_emoji)
      : undefined;
    message.event_update_emoji = (object.event_update_emoji !== undefined && object.event_update_emoji !== null)
      ? EventUpdateEmoji.fromPartial(object.event_update_emoji)
      : undefined;
    message.event_delete_emoji = (object.event_delete_emoji !== undefined && object.event_delete_emoji !== null)
      ? EventDeleteEmoji.fromPartial(object.event_delete_emoji)
      : undefined;
    return message;
  },
};
...
function createBaseEventCreateEmoji(): EventCreateEmoji {
  return { id: "", clan_id: "", short_name: "", source: "", category: "" };
}

export const EventCreateEmoji = {
  encode(message: EventCreateEmoji, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.clan_id !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): EventCreateEmoji {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseEventCreateEmoji();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): EventCreateEmoji {
    return {
      id: isSet(object.id) ? globalThis.String(object.id) : "",
      clan_id: isSet(object.clan_id) ? globalThis.String(object.clan_id) : "",
  ...
  toJSON(message: EventCreateEmoji): unknown {
    const obj: any = {};
    if (message.id !== "") {
      obj.id = message.id;
    }
  ...
  create<I extends Exact<DeepPartial<EventCreateEmoji>, I>>(base?: I): EventCreateEmoji {
    return EventCreateEmoji.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventCreateEmoji>, I>>(object: I): EventCreateEmoji {
    const message = createBaseEventCreateEmoji();
    message.id = object.id ?? "";
    message.clan_id = object.clan_id ?? "";
...
function createBaseEventUpdateEmoji(): EventUpdateEmoji {
  return { id: "", clan_id: "", short_name: "", source: "", category: "" };
}

export const EventUpdateEmoji = {
  encode(message: EventUpdateEmoji, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.clan_id !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): EventUpdateEmoji {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseEventUpdateEmoji();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): EventUpdateEmoji {
    return {
      id: isSet(object.id) ? globalThis.String(object.id) : "",
      clan_id: isSet(object.clan_id) ? globalThis.String(object.clan_id) : "",
      short_name: isSet(object.short_name) ? globalThis.String(object.short_name) : "",
  ...
  toJSON(message: EventUpdateEmoji): unknown {
    const obj: any = {};
    if (message.id !== "") {
      obj.id = message.id;
    }
  ...
  create<I extends Exact<DeepPartial<EventUpdateEmoji>, I>>(base?: I): EventUpdateEmoji {
    return EventUpdateEmoji.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventUpdateEmoji>, I>>(object: I): EventUpdateEmoji {
    const message = createBaseEventUpdateEmoji();
    message.id = object.id ?? "";
    message.clan_id = object.clan_id ?? "";
    message.short_name = object.short_name ?? "";
...
function createBaseEventDeleteEmoji(): EventDeleteEmoji {
  return { id: "", clan_id: "" };
}

export const EventDeleteEmoji = {
  encode(message: EventDeleteEmoji, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.clan_id !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): EventDeleteEmoji {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseEventDeleteEmoji();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): EventDeleteEmoji {
    return {
      id: isSet(object.id) ? globalThis.String(object.id) : "",
      clan_id: isSet(object.clan_id) ? globalThis.String(object.clan_id) : "",
    };
  ...
  toJSON(message: EventDeleteEmoji): unknown {
    const obj: any = {};
    if (message.id !== "") {
      obj.id = message.id;
    }
  ...
  create<I extends Exact<DeepPartial<EventDeleteEmoji>, I>>(base?: I): EventDeleteEmoji {
    return EventDeleteEmoji.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventDeleteEmoji>, I>>(object: I): EventDeleteEmoji {
    const message = createBaseEventDeleteEmoji();
    message.id = object.id ?? "";
    message.clan_id = object.clan_id ?? "";
    return message;
