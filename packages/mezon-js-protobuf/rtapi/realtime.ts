...
export interface Envelope {
  ...
  /** voice call */
  call_request?: CallRequest | undefined;
  /** voice call */
  call_accept?: CallAccept | undefined;
  /** webrtc */
...
export const Envelope = {
  encode(
    ...
    if (message.ice_candidate_init !== undefined) {
      ICECandidateInit.encode(
        message.ice_candidate_init,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 64:
          ...
          message.ice_candidate_init = ICECandidateInit.decode(
            reader,
            reader.uint32()
          );
          continue;
  ...
  fromJSON(object: any): Envelope {
    return {
      ...
      unmute_event: isSet(object.unmute_event)
        ...
        : undefined,
      call_request: isSet(object.call_request)
        ? CallRequest.fromJSON(object.call_request)
        : undefined,
      call_accept: isSet(object.call_accept)
        ? CallAccept.fromJSON(object.call_accept)
        : undefined,
  ...
  toJSON(message: Envelope): unknown {
    ...
    if (message.ice_candidate_init !== undefined) {
      obj.ice_candidate_init = ICECandidateInit.toJSON(
        message.ice_candidate_init
      );
    }
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<Envelope>, I>>(object: I): Envelope {
    ...
    message.unmute_event =
      object.unmute_event !== undefined && object.unmute_event !== null
        ...
        : undefined;
    message.call_request =
      object.call_request !== undefined && object.call_request !== null
        ? CallRequest.fromPartial(object.call_request)
        : undefined;
    message.call_accept =
      object.call_accept !== undefined && object.call_accept !== null
        ? CallAccept.fromPartial(object.call_accept)
        : undefined;
    message.ice_candidate_init =
      object.ice_candidate_init !== undefined &&
      object.ice_candidate_init !== null
...
export const CallRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<CallRequest>, I>>(
    object: I
  ): CallRequest {
    const message = createBaseCallRequest();
...
export const CallAccept = {
  ...
  fromPartial<I extends Exact<DeepPartial<CallAccept>, I>>(
    object: I
  ): CallAccept {
    const message = createBaseCallAccept();
    message.type = object.type ?? "";
...
export const ICECandidateInit = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.sdpMLineIndex = Int32Value.decode(
            reader,
            reader.uint32()
          ).value;
          continue;
        case 4:
          ...
          message.usernameFragment = StringValue.decode(
            reader,
            reader.uint32()
          ).value;
          continue;
  ...
  fromJSON(object: any): ICECandidateInit {
    return {
      ...
      usernameFragment: isSet(object.usernameFragment)
        ? String(object.usernameFragment)
        : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<ICECandidateInit>, I>>(
    base?: I
  ): ICECandidateInit {
    return ICECandidateInit.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ICECandidateInit>, I>>(
    object: I
  ): ICECandidateInit {
    const message = createBaseICECandidateInit();
  ...
  fromJSON(object: any): UserChannelAdded {
    return {
      ...
      is_public: isSet(object.is_public)
        ? globalThis.Boolean(object.is_public)
        : false,
      parent_id: isSet(object.parent_id)
