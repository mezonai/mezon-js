...
function createBaseNotificationCategorySettingEvent(): NotificationCategorySettingEvent {
  return { id: "", notification_setting_type: 0, time_mute: undefined, active: 0, category_id: "" };
}
...
function createBaseNotificationClanSettingEvent(): NotificationClanSettingEvent {
  return { id: "", notification_setting_type: 0, clan_id: "" };
}
...
function createBaseNotifiReactMessageEvent(): NotifiReactMessageEvent {
  return { id: "", user_id: "", channel_id: "", channel_id_req: "" };
}
...
export const NotifiReactMessageEvent = {
  encode(message: NotifiReactMessageEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.channel_id_req !== "") {
      writer.uint32(34).string(message.channel_id_req);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.channel_id_req = reader.string();
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): NotifiReactMessageEvent {
    return {
      ...
      user_id: isSet(object.user_id) ? String(object.user_id) : "",
      channel_id: isSet(object.channel_id) ? String(object.channel_id) : "",
      channel_id_req: isSet(object.channel_id_req) ? String(object.channel_id_req) : "",
    };
  },
  ...
  toJSON(message: NotifiReactMessageEvent): unknown {
    ...
    message.user_id !== undefined && (obj.user_id = message.user_id);
    message.channel_id !== undefined && (obj.channel_id = message.channel_id);
    message.channel_id_req !== undefined && (obj.channel_id_req = message.channel_id_req);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<NotifiReactMessageEvent>, I>>(object: I): NotifiReactMessageEvent {
    ...
    message.user_id = object.user_id ?? "";
    message.channel_id = object.channel_id ?? "";
    message.channel_id_req = object.channel_id_req ?? "";
    return message;
  },
};
