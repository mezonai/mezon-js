...
export interface Envelope {
  ...
  add_user_emoji_usage_event?:
    ...
    | undefined;
  /**  */
  get_user_emoji_usage_event?: GetUserEmojiUsageEvent | undefined;
}
...
export const Envelope = {
  ...
  toJSON(message: Envelope): unknown {
    ...
    message.role_assign_event !== undefined && (obj.role_assign_event = message.role_assign_event
      ? RoleAssignedEvent.toJSON(message.role_assign_event)
      : undefined);
    message.add_user_emoji_usage_event !== undefined &&
      (obj.add_user_emoji_usage_event = message.add_user_emoji_usage_event
        ? AddUserEmojiUsageEvent.toJSON(message.add_user_emoji_usage_event)
        : undefined);
    message.get_user_emoji_usage_event !== undefined &&
      (obj.get_user_emoji_usage_event = message.get_user_emoji_usage_event
        ? GetUserEmojiUsageEvent.toJSON(message.get_user_emoji_usage_event)
        : undefined);
    return obj;
  },
...
export const AddClanUserEvent = {
  ...
  toJSON(message: AddClanUserEvent): unknown {
    ...
    message.user !== undefined && (obj.user = message.user ? UserProfileRedis.toJSON(message.user) : undefined);
    return obj;
  },
...
export const HashtagDmListEvent = {
  ...
  fromJSON(object: any): HashtagDmListEvent {
    return {
      ...
      hashtag_dm: Array.isArray(object?.hashtag_dm) ? object.hashtag_dm.map((e: any) => HashtagDm.fromJSON(e)) : [],
    };
  },
...
export const UserChannelAdded = {
  ...
  fromJSON(object: any): UserChannelAdded {
    return {
      channel_id: isSet(object.channel_id) ? String(object.channel_id) : "",
      users: Array.isArray(object?.users) ? object.users.map((e: any) => UserProfileRedis.fromJSON(e)) : [],
      status: isSet(object.status) ? String(object.status) : "",
      clan_id: isSet(object.clan_id) ? String(object.clan_id) : "",
      channel_type: isSet(object.channel_type) ? Number(object.channel_type) : 0,
      is_public: isSet(object.is_public) ? Boolean(object.is_public) : false,
  ...
  toJSON(message: UserChannelAdded): unknown {
    ...
    message.channel_id !== undefined && (obj.channel_id = message.channel_id);
    if (message.users) {
      obj.users = message.users.map((e) => e ? UserProfileRedis.toJSON(e) : undefined);
    } else {
      obj.users = [];
    }
    message.status !== undefined && (obj.status = message.status);
...
export const UserProfileRedis = {
  ...
  fromJSON(object: any): UserProfileRedis {
    return {
      ...
      display_name: isSet(object.display_name) ? String(object.display_name) : "",
      about_me: isSet(object.about_me) ? String(object.about_me) : "",
      custom_status: isSet(object.custom_status) ? String(object.custom_status) : "",
      create_time_second: isSet(object.create_time_second) ? Number(object.create_time_second) : 0,
  ...
  toJSON(message: UserProfileRedis): unknown {
    ...
    message.display_name !== undefined && (obj.display_name = message.display_name);
    message.about_me !== undefined && (obj.about_me = message.about_me);
    message.custom_status !== undefined && (obj.custom_status = message.custom_status);
    message.create_time_second !== undefined && (obj.create_time_second = Math.round(message.create_time_second));
...
export const NotificationChannelCategorySettingEvent = {
  ...
  fromJSON(object: any): NotificationChannelCategorySettingEvent {
    return {
      clan_id: isSet(object.clan_id) ? String(object.clan_id) : "",
      notification_channel_category_settings_list: Array.isArray(object?.notification_channel_category_settings_list)
  ...
  toJSON(message: NotificationChannelCategorySettingEvent): unknown {
    const obj: any = {};
    message.clan_id !== undefined && (obj.clan_id = message.clan_id);
    if (message.notification_channel_category_settings_list) {
      obj.notification_channel_category_settings_list = message.notification_channel_category_settings_list.map((e) =>
        e ? NotificationChannelCategorySetting.toJSON(e) : undefined
      );
    } else {
      obj.notification_channel_category_settings_list = [];
    }
    return obj;
  },
  ...
  create<I extends Exact<DeepPartial<NotificationChannelCategorySettingEvent>, I>>(
    ...
    return NotificationChannelCategorySettingEvent.fromPartial(base ?? {});
  },
...
export const UserEmojiUsage = {
  ...
  create<I extends Exact<DeepPartial<UserEmojiUsage>, I>>(base?: I): UserEmojiUsage {
    return UserEmojiUsage.fromPartial(base ?? {});
  },
...
export const AddUserEmojiUsageEvent = {
  ...
  create<I extends Exact<DeepPartial<AddUserEmojiUsageEvent>, I>>(base?: I): AddUserEmojiUsageEvent {
    return AddUserEmojiUsageEvent.fromPartial(base ?? {});
  },
...
export const GetUserEmojiUsageEvent = {
  ...
  fromJSON(object: any): GetUserEmojiUsageEvent {
    return {
      clanId: isSet(object.clanId) ? String(object.clanId) : "",
      user_emoji_usage: Array.isArray(object?.user_emoji_usage)
  ...
  toJSON(message: GetUserEmojiUsageEvent): unknown {
    const obj: any = {};
    message.clanId !== undefined && (obj.clanId = message.clanId);
    if (message.user_emoji_usage) {
      obj.user_emoji_usage = message.user_emoji_usage.map((e) => e ? UserEmojiUsage.toJSON(e) : undefined);
    } else {
      obj.user_emoji_usage = [];
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<GetUserEmojiUsageEvent>, I>>(base?: I): GetUserEmojiUsageEvent {
    return GetUserEmojiUsageEvent.fromPartial(base ?? {});
  },
