...
export interface Envelope {
  ...
  add_clan_user_event?:
    ...
    | undefined;
  /** send stream 66 */
  send_stream_event?: SendStreamEvent | undefined;
}
...
export const Envelope = {
  encode(message: Envelope, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.send_stream_event !== undefined) {
      SendStreamEvent.encode(message.send_stream_event, writer.uint32(434).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 53:
          ...
          break;
        case 54:
          message.send_stream_event = SendStreamEvent.decode(reader, reader.uint32());
          break;
        default:
  ...
  fromJSON(object: any): Envelope {
    return {
      ...
      add_clan_user_event: isSet(object.add_clan_user_event)
        ...
        : undefined,
      send_stream_event: isSet(object.send_stream_event)
        ? SendStreamEvent.fromJSON(object.send_stream_event)
        : undefined,
    };
  },
  ...
  toJSON(message: Envelope): unknown {
    ...
    message.add_clan_user_event !== undefined && (obj.add_clan_user_event = message.add_clan_user_event
      ...
      : undefined);
    message.send_stream_event !== undefined &&
      (obj.send_stream_event = message.send_stream_event
        ? SendStreamEvent.toJSON(message.send_stream_event)
        : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Envelope>, I>>(object: I): Envelope {
    ...
    message.add_clan_user_event = (object.add_clan_user_event !== undefined && object.add_clan_user_event !== null)
      ...
      : undefined;
    message.send_stream_event = (object.send_stream_event !== undefined && object.send_stream_event !== null)
      ? SendStreamEvent.fromPartial(object.send_stream_event)
      : undefined;
    return message;
  },
};
...
export const AddClanUserEvent = {
  ...
  toJSON(message: AddClanUserEvent): unknown {
    ...
    message.user !== undefined && (obj.user = message.user ? AddUsers.toJSON(message.user) : undefined);
    return obj;
  },
...
function createBaseSendStreamEvent(): SendStreamEvent {
  return { message: "" };
}

export const SendStreamEvent = {
  encode(message: SendStreamEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.message !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SendStreamEvent {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSendStreamEvent();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): SendStreamEvent {
    return { message: isSet(object.message) ? String(object.message) : "" };
  },

  toJSON(message: SendStreamEvent): unknown {
    const obj: any = {};
    message.message !== undefined && (obj.message = message.message);
    return obj;
  },

  create<I extends Exact<DeepPartial<SendStreamEvent>, I>>(base?: I): SendStreamEvent {
    return SendStreamEvent.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<SendStreamEvent>, I>>(object: I): SendStreamEvent {
    const message = createBaseSendStreamEvent();
    message.message = object.message ?? "";
    return message;
  },
