(function (global, factory) {
  ...
  */
  ...
  var NakamaApi = /** @class */ (function () {
      ...
      /**  */
      NakamaApi.prototype.listCategoryDescs = function (bearerToken, clanId, creatorId, categoryName, categoryId, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (clanId === null || clanId === undefined) {
              throw new Error("'clanId' is a required parameter but is null or undefined.");
          }
          var urlPath = "/v2/categorydesc/{clanId}"
      ...
      /** List user channels */
      NakamaApi.prototype.listChannelDescs = function (bearerToken, limit, state, cursor, clanId, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          var urlPath = "/v2/channeldesc";
          var queryParams = new Map();
          queryParams.set("limit", limit);
      ...
      NakamaApi.prototype.createChannelDesc = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      NakamaApi.prototype.postLastSeenMessage = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
          }
          var urlPath = "/v2/channeldesc/last-message-seen";
          var queryParams = new Map();
          var bodyJson = "";
          bodyJson = JSON.stringify(body || {});
          var fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
      ...
      NakamaApi.prototype.deleteChannelDesc = function (bearerToken, channelId, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (channelId === null || channelId === undefined) {
              throw new Error("'channelId' is a required parameter but is null or undefined.");
          }
          var urlPath = "/v2/channeldesc/{channelId}"
              .replace("{channelId}", encodeURIComponent(String(channelId)));
          var queryParams = new Map();
          var bodyJson = "";
          var fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
      ...
      NakamaApi.prototype.updateChannelDesc = function (bearerToken, channelId, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (channelId === null || channelId === undefined) {
              throw new Error("'channelId' is a required parameter but is null or undefined.");
      ...
      NakamaApi.prototype.addChannelUsers = function (bearerToken, channelId, userIds, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (channelId === null || channelId === undefined) {
              throw new Error("'channelId' is a required parameter but is null or undefined.");
          }
          var urlPath = "/v2/channeldesc/{channelId}/add"
              .replace("{channelId}", encodeURIComponent(String(channelId)));
          var queryParams = new Map();
      ...
      NakamaApi.prototype.leaveChannel = function (bearerToken, channelId, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (channelId === null || channelId === undefined) {
              throw new Error("'channelId' is a required parameter but is null or undefined.");
          }
          var urlPath = "/v2/channeldesc/{channelId}/leave"
              .replace("{channelId}", encodeURIComponent(String(channelId)));
          var queryParams = new Map();
          var bodyJson = "";
          var fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
      ...
      NakamaApi.prototype.removeChannelUsers = function (bearerToken, channelId, userIds, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (channelId === null || channelId === undefined) {
              throw new Error("'channelId' is a required parameter but is null or undefined.");
          }
          var urlPath = "/v2/channeldesc/{channelId}/remove"
              .replace("{channelId}", encodeURIComponent(String(channelId)));
          var queryParams = new Map();
          queryParams.set("user_ids", userIds);
          var bodyJson = "";
      ...
      NakamaApi.prototype.listChannelUsers = function (bearerToken, channelId, limit, state, cursor, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (channelId === null || channelId === undefined) {
              throw new Error("'channelId' is a required parameter but is null or undefined.");
          }
          var urlPath = "/v2/channeldesc/{channelId}/user"
              .replace("{channelId}", encodeURIComponent(String(channelId)));
          var queryParams = new Map();
          queryParams.set("limit", limit);
          queryParams.set("state", state);
      ...
      /**  */
      NakamaApi.prototype.channelMessageTyping = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
          }
          var urlPath = "/v2/channelmessagetyping";
          var queryParams = new Map();
          var bodyJson = "";
          bodyJson = JSON.stringify(body || {});
          var fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
      ...
      /** List clans */
      NakamaApi.prototype.listClanDescs = function (bearerToken, limit, state, cursor, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          var urlPath = "/v2/clandesc";
          var queryParams = new Map();
          queryParams.set("limit", limit);
          queryParams.set("state", state);
          queryParams.set("cursor", cursor);
      ...
      /** Create a clan */
      NakamaApi.prototype.createClanDesc = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      NakamaApi.prototype.updateClanDesc = function (bearerToken, clanId, creatorId, clanName, logo, banner, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (clanId === null || clanId === undefined) {
              throw new Error("'clanId' is a required parameter but is null or undefined.");
          }
          var urlPath = "/v2/clandesc/{clanId}"
              .replace("{clanId}", encodeURIComponent(String(clanId)));
          var queryParams = new Map();
          queryParams.set("creator_id", creatorId);
      ...
      NakamaApi.prototype.getClanDescProfile = function (bearerToken, clanId, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (clanId === null || clanId === undefined) {
              throw new Error("'clanId' is a required parameter but is null or undefined.");
          }
          var urlPath = "/v2/clandescprofile/{clanId}"
              .replace("{clanId}", encodeURIComponent(String(clanId)));
          var queryParams = new Map();
          var bodyJson = "";
          var fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
      ...
      NakamaApi.prototype.updateClanDescProfile = function (bearerToken, clanId, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (clanId === null || clanId === undefined) {
              throw new Error("'clanId' is a required parameter but is null or undefined.");
      ...
      /**  */
      NakamaApi.prototype.createCategoryDesc = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
          }
          var urlPath = "/v2/createcategory";
          var queryParams = new Map();
          var bodyJson = "";
          bodyJson = JSON.stringify(body || {});
          var fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
      ...
      /**  */
      NakamaApi.prototype.deleteCategoryDesc = function (bearerToken, creatorId, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (creatorId === null || creatorId === undefined) {
              throw new Error("'creatorId' is a required parameter but is null or undefined.");
          }
          var urlPath = "/v2/deletecategory/{creatorId}"
      ...
      NakamaApi.prototype.kickGroupUsers = function (bearerToken, groupId, userIds, options) {
          ...
          var urlPath = "/v2/group/{groupId}/remove"
              .replace("{groupId}", encodeURIComponent(String(groupId)));
          var queryParams = new Map();
          queryParams.set("user_ids", userIds);
          var bodyJson = "";
      ...
      /** Add users to a channel. */
      NakamaApi.prototype.createLinkInviteUser = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
          }
          var urlPath = "/v2/invite";
          var queryParams = new Map();
          var bodyJson = "";
          bodyJson = JSON.stringify(body || {});
          var fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
      ...
      /** Add users to a channel. */
      NakamaApi.prototype.inviteUser = function (bearerToken, inviteId, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (inviteId === null || inviteId === undefined) {
              throw new Error("'inviteId' is a required parameter but is null or undefined.");
      ...
      /** List user roles */
      NakamaApi.prototype.listRoles = function (bearerToken, limit, state, cursor, clanId, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      NakamaApi.prototype.createRole = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
      ...
      /** Delete a role by ID. */
      NakamaApi.prototype.deleteRole = function (bearerToken, roleId, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (roleId === null || roleId === undefined) {
              throw new Error("'roleId' is a required parameter but is null or undefined.");
          }
          var urlPath = "/v2/roles/{roleId}"
      ...
      NakamaApi.prototype.updateRole = function (bearerToken, roleId, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (roleId === null || roleId === undefined) {
              throw new Error("'roleId' is a required parameter but is null or undefined.");
      ...
      NakamaApi.prototype.rpcFunc2 = function (bearerToken, basicAuthUsername, basicAuthPassword, id, payload, httpKey, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
      ...
      /** Execute a Lua function on the server. */
      NakamaApi.prototype.rpcFunc = function (bearerToken, basicAuthUsername, basicAuthPassword, id, payload, httpKey, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (id === null || id === undefined) {
              throw new Error("'id' is a required parameter but is null or undefined.");
      ...
      NakamaApi.prototype.updateCategory = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
          }
          var urlPath = "/v2/updatecategory";
          var queryParams = new Map();
          var bodyJson = "";
          bodyJson = JSON.stringify(body || {});
          var fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
      ...
      /**  */
      NakamaApi.prototype.updateUser = function (bearerToken, body, options) {
          var _this = this;
          if (options === void 0) { options = {}; }
          if (body === null || body === undefined) {
              throw new Error("'body' is a required parameter but is null or undefined.");
          }
          var urlPath = "/v2/user/update";
          var queryParams = new Map();
          var bodyJson = "";
          bodyJson = JSON.stringify(body || {});
          var fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
  ...
  var DefaultSocket = /** @class */ (function () {
      ...
      DefaultSocket.prototype.joinChat = function (target_id, target, type, persistence, hidden) {
          return __awaiter(this, void 0, void 0, function () {
              var response;
              return __generator(this, function (_a) {
                  switch (_a.label) {
      ...
      DefaultSocket.prototype.writeChatMessage = function (clan_id, channel_id, content) {
          return __awaiter(this, void 0, void 0, function () {
              var response;
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0: return [4 /*yield*/, this.send({ channel_message_send: { clan_id: clan_id, channel_id: channel_id, content: content } })];
                      case 1:
                          response = _a.sent();
                          return [2 /*return*/, response.channel_message_ack];
                  }
  ...
  var Client = /** @class */ (function () {
      ...
      Client.prototype.addChannelUsers = function (session, channelId, ids) {
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                      ...
                      case 1:
                          _a.sent();
                          _a.label = 2;
                      case 2: return [2 /*return*/, this.apiClient.addChannelUsers(session.token, channelId, ids).then(function (response) {
                              return response !== undefined;
                          })];
                  }
              });
      ...
      Client.prototype.createChannelDesc = function (session, request) {
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                      ...
                      case 1:
                          _a.sent();
                          _a.label = 2;
                      case 2: return [2 /*return*/, this.apiClient.createChannelDesc(session.token, request).then(function (response) {
      ...
      /** Create a clan */
      Client.prototype.createClanDesc = function (session, request) {
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                      ...
                      case 1:
                          _a.sent();
                          _a.label = 2;
                      case 2: return [2 /*return*/, this.apiClient.createClanDesc(session.token, request).then(function (response) {
                              return Promise.resolve(response);
                          })];
                  }
              });
      ...
      /**  */
      Client.prototype.createCategoryDesc = function (session, request) {
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                      ...
                      case 1:
                          _a.sent();
                          _a.label = 2;
                      case 2: return [2 /*return*/, this.apiClient.createCategoryDesc(session.token, request).then(function (response) {
                              return Promise.resolve(response);
                          })];
                  }
              });
      ...
      /** Delete a channel by ID. */
      Client.prototype.deleteChannelDesc = function (session, channelId) {
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                      ...
                      case 1:
                          _a.sent();
                          _a.label = 2;
                      case 2: return [2 /*return*/, this.apiClient.deleteChannelDesc(session.token, channelId).then(function (response) {
                              return response !== undefined;
                          })];
                  }
              });
      ...
      /** Delete a clan desc by ID. */
      Client.prototype.deleteClanDesc = function (session, clanDescId) {
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                      ...
                      case 1:
                          _a.sent();
                          _a.label = 2;
                      case 2: return [2 /*return*/, this.apiClient.deleteClanDesc(session.token, clanDescId).then(function (response) {
                              return response !== undefined;
                          })];
                  }
              });
      ...
      Client.prototype.deleteCategoryDesc = function (session, creatorId) {
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                      ...
                      case 1:
                          _a.sent();
                          _a.label = 2;
                      case 2: return [2 /*return*/, this.apiClient.deleteCategoryDesc(session.token, creatorId).then(function (response) {
                              return response !== undefined;
                          })];
                  }
              });
      ...
      Client.prototype.removeChannelUsers = function (session, channelId, ids) {
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                      ...
                      case 1:
                          _a.sent();
                          _a.label = 2;
                      case 2: return [2 /*return*/, this.apiClient.removeChannelUsers(session.token, channelId, ids).then(function (response) {
                              return Promise.resolve(response != undefined);
                          })];
                  }
              });
      ...
      Client.prototype.listChannelUsers = function (session, channelId, state, limit, cursor) {
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                      ...
                      case 1:
                          _a.sent();
                          _a.label = 2;
                      case 2: return [2 /*return*/, this.apiClient.listChannelUsers(session.token, channelId, limit, state, cursor).then(function (response) {
                              var result = {
                                  channel_users: [],
                              ...
                              response.channel_users.forEach(function (gu) {
      ...
      /** List channels. */
      Client.prototype.listChannelDescs = function (session, limit, state, cursor, clanId) {
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                      ...
                      case 1:
                          _a.sent();
                          _a.label = 2;
                      case 2: return [2 /*return*/, this.apiClient.listChannelDescs(session.token, limit, state, cursor, clanId).then(function (response) {
                              var result = {
                                  channeldesc: [],
                                  next_cursor: response.next_cursor,
                                  prev_cursor: response.prev_cursor,
      ...
      /** List clans */
      Client.prototype.listClanDescs = function (session, limit, state, cursor) {
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                      ...
                      case 1:
                          _a.sent();
                          _a.label = 2;
                      case 2: return [2 /*return*/, this.apiClient.listClanDescs(session.token, limit, state, cursor).then(function (response) {
                              var result = {
                                  clandesc: [],
                              };
      ...
      /** List categories. */
      Client.prototype.listCategoryDescs = function (session, clanId, creatorId, categoryName) {
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                      ...
                      case 1:
                          _a.sent();
                          _a.label = 2;
                      case 2: return [2 /*return*/, this.apiClient.listCategoryDescs(session.token, clanId, creatorId, categoryName).then(function (response) {
                              var result = {
                                  categorydesc: [],
                              };
      ...
      /** Get a clan desc profile */
      Client.prototype.getClanDescProfile = function (session, clanId) {
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                      ...
                      case 1:
                          _a.sent();
                          _a.label = 2;
                      case 2: return [2 /*return*/, this.apiClient.getClanDescProfile(session.token, clanId).then(function (response) {
                              return Promise.resolve(response);
                          })];
                  }
              });
      ...
      Client.prototype.rpc = function (session, basicAuthUsername, basicAuthPassword, id, input) {
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                      ...
                      case 1:
                          _a.sent();
                          _a.label = 2;
                      case 2: return [2 /*return*/, this.apiClient.rpcFunc(session.token, basicAuthUsername, basicAuthPassword, id, JSON.stringify(input)).then(function (response) {
                              return Promise.resolve({
                                  id: response.id,
      ...
      /** Update fields in a given channel */
      Client.prototype.updateChannelDesc = function (session, channelId, request) {
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                      ...
                      case 1:
                          _a.sent();
                          _a.label = 2;
                      case 2: return [2 /*return*/, this.apiClient.updateChannelDesc(session.token, channelId, request).then(function (response) {
                              return response !== undefined;
                          })];
                  }
              });
      ...
      /** Update fields in a given clan. */
      Client.prototype.updateClanDesc = function (session, clanId, request) {
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                      ...
                      case 1:
                          _a.sent();
                          _a.label = 2;
                      case 2: return [2 /*return*/, this.apiClient.updateClanDesc(session.token, clanId, request === null || request === void 0 ? void 0 : request.creator_id, request === null || request === void 0 ? void 0 : request.clan_name, request === null || request === void 0 ? void 0 : request.logo, request === null || request === void 0 ? void 0 : request.banner).then(function (response) {
                              return response !== undefined;
                          })];
                  }
              });
      ...
      /** Update fields in a given category. */
      Client.prototype.updateCategory = function (session, request) {
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                      ...
                      case 1:
                          _a.sent();
                          _a.label = 2;
                      case 2: return [2 /*return*/, this.apiClient.updateCategory(session.token, request).then(function (response) {
                              return response !== undefined;
                          })];
                  }
              });
      ...
      /** Update fields in a given clan profile. */
      Client.prototype.updateClanDescProfile = function (session, clanId, request) {
          return __awaiter(this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                      ...
                      case 1:
                          _a.sent();
                          _a.label = 2;
                      case 2: return [2 /*return*/, this.apiClient.updateClanDescProfile(session.token, clanId, request).then(function (response) {
                              return response !== undefined;
                          })];
                  }
              });
