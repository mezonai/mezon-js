...
export interface ChannelDMPayload {
  channel_id: string;
  type: number;
}
...
export interface Client {
  ...
  sendMessageUser: (userId: string, msg: string, messOptions: {[x: string]: any}, attachments: Array<ApiMessageAttachment>, refs: Array<ApiMessageRef>, channelDMUser?: ChannelDMPayload) => Promise<ChannelMessageAck>; 
}
